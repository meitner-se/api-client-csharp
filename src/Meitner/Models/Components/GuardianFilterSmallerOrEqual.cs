...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class GuardianFilterSmallerOrEqual
    {
        ...
        /// </summary>
        [JsonProperty("meta")]
        public GuardianFilterSmallerOrEqualMeta? Meta { get; set; } = null;
        ...
        public GuardianFilterSmallerOrEqualExternal? External { get; set; } = null;

        /// <summary>
        /// The address of the guardian
        /// </summary>
        [JsonProperty("address")]
        public GuardianFilterSmallerOrEqualAddress? Address { get; set; } = null;
    }
}