...
namespace Meitner.Models.Components
{
    ...
    public static class GroupSearchNotEqualsCategoryExtension
    {
        public static string Value(this GroupSearchNotEqualsCategory value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GroupSearchNotEqualsCategory ToEnum(this string value)
        {
            foreach(var field in typeof(GroupSearchNotEqualsCategory).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is GroupSearchNotEqualsCategory)
                    {
                        return (GroupSearchNotEqualsCategory)enumVal;
                    }
                }
            }
