...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementFilterLike
    {
        ...
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementFilterLikeMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementFilterLikeExternal? External { get; set; } = null;
