...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementFilterSmallerThan
    {
        /// <summary>
        /// Metadata information for the EmployeePlacement.
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementFilterSmallerThanMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementFilterSmallerThanExternal? External { get; set; } = null;
