...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementSearchSmallerThan
    {
        /// <summary>
        /// Metadata information for the EmployeePlacement.
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementSearchSmallerThanMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementSearchSmallerThanExternal? External { get; set; } = null;
