...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementSearchNotNull
    {
        /// <summary>
        /// Metadata information for the EmployeePlacement.
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementSearchNotNullMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementSearchNotNullExternal? External { get; set; } = null;
