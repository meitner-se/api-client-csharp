...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementSearchContains
    {
        ...
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementSearchContainsMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementSearchContainsExternal? External { get; set; } = null;
