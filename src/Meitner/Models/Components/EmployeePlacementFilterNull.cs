...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementFilterNull
    {
        /// <summary>
        /// Metadata information for the EmployeePlacement.
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementFilterNullMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementFilterNullExternal? External { get; set; } = null;
