...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementSearchGreaterThan
    {
        /// <summary>
        /// Metadata information for the EmployeePlacement.
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementSearchGreaterThanMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementSearchGreaterThanExternal? External { get; set; } = null;
