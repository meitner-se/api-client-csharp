...
<!-- UsageSnippet language="csharp" operationID="StudentList" method="get" path="/student" -->
```csharp
using Meitner;
...
<!-- UsageSnippet language="csharp" operationID="StudentCreate" method="post" path="/student" -->
```csharp
using Meitner;
using Meitner.Models.Components;
using System;
...
<!-- UsageSnippet language="csharp" operationID="StudentSearch" method="post" path="/student/_search" -->
```csharp
using Meitner;
using Meitner.Models.Components;
using System;
...
<!-- UsageSnippet language="csharp" operationID="StudentGet" method="get" path="/student/{id}" -->
```csharp
using Meitner;
using Meitner.Models.Components;
...
<!-- UsageSnippet language="csharp" operationID="StudentUpdate" method="patch" path="/student/{id}" -->
```csharp
using Meitner;
using Meitner.Models.Components;
using System;
