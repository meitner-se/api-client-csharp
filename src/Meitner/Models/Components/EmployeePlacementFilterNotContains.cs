...
namespace Meitner.Models.Components
{
    ...
    /// </summary>
    public class EmployeePlacementFilterNotContains
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("meta")]
        public EmployeePlacementFilterNotContainsMeta? Meta { get; set; } = null;
        ...
        public EmployeePlacementFilterNotContainsExternal? External { get; set; } = null;
